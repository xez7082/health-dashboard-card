// HEALTH DASHBOARD CARD – VERSION 36 (COMPLETE EDITION)
...
// EDITOR V36 (THE COMPLETE EDITOR)
        ...
        <div id="list">
          ${person.sensors.map((s, i) => `
            <div class="s-item">
              ...
              <button class="del" data-idx="${i}" style="width:100%; background:#7f1d1d; color:white; border:none; padding:6px; margin-top:8px; border-radius:4px; cursor:pointer;">SUPPRIMER</button>
            </div>
          `).join('')}
        </div>
        <button id="add" style="width:100%; margin-top:15px; padding:12px; background:#065f46; color:white; border:none; border-radius:6px; cursor:pointer; font-weight:bold;">+ AJOUTER UN CAPTEUR</button>
      </div>`;
    this._setup();
  }
  _setup() {
...
window.customCards.push({ type: "health-dashboard-card", name: "Health Dashboard V36" });
